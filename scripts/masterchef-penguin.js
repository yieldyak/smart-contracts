const masterchefPenguin = async () => {
    const MASTERCHEF = "0x8AC8ED5839ba269Be2619FfeB3507baB6275C257";

    const ABI_PAIR = require("../abis/IPair");
    const ABI_MASTERCHEF = require("../abis/IPenguinChef");
    ...
    console.log("PEFI contract: ", await masterChefContract.pefi());
}
