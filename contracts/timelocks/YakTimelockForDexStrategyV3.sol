...
contract YakTimelockForDexStrategyV3 {
     ...
     */
    function setMinTokensToReinvest(address _strategy, uint256 newValue) external onlyManager {
     ...
     */
    function setMaxTokensToDepositWithoutReinvest(address _strategy, uint256 newValue) external onlyManager {
