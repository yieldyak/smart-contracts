...
contract BenqiStrategyForLP is YakStrategy {
    ...
    function reinvest() external override onlyEOA {
        (, uint256 qiAmount, uint256 totalAvaxAmount) = _checkRewards();
        require(
            totalAvaxAmount >= MIN_TOKENS_TO_REINVEST,
            "BenqiStrategyForLP::reinvest"
        );
        _reinvest(qiAmount);
    }
    ...
    function _reinvest(uint256 qiAmount) private {
        ...
        uint256 qiAsWavax = DexLibrary.swap(
            qiAmount,
    ...
    function _reinvestToken(IERC20 token, uint256 amount)
        private
    ...
    function _safeTransfer(
        ...
        require(
            ...
            "BenqiStrategyForLP::TRANSFER_FROM_FAILED"
        );
    }
        ...
        onlyOwner
    {
        ...
        require(
            ...
            "BenqiStrategyForLP::rescueDeployedFunds"
        );
