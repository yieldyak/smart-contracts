 ...
 */
contract JoeStrategyV5 is YakStrategy {
    ...
    function assignSwapPairSafely(
        ...
        (, address extraRewardToken, , ) = stakingContract.pendingTokens(
            PID,
            address(this)
        );
        require(
    ...
    function _deposit(address account, uint256 amount) private onlyAllowedDeposits {
        require(DEPOSITS_ENABLED == true, "JoeStrategyV5::_deposit");
    ...
    function _withdrawDepositTokens(uint256 amount) private {
        require(amount > 0, "JoeStrategyV5::_withdrawDepositTokens");
        stakingContract.withdraw(PID, amount);
    }

    function reinvest() external override onlyEOA {
        uint256 unclaimedRewards = checkReward();
        require(unclaimedRewards >= MIN_TOKENS_TO_REINVEST, "JoeStrategyV5::reinvest");
        (
            uint256 poolTokenAmount,
            address extraRewardTokenAddress,
            uint256 extraRewardTokenAmount,
    ...
    function _reinvest(
        ...
        uint256 amount = _pendingWavax.add(
    ...
    function _stakeDepositTokens(uint256 amount) private {
        require(amount > 0, "JoeStrategyV5::_stakeDepositTokens");
        _setAllowances(amount);
        ...
        onlyOwner
    {
        ...
        require(
            ...
            "JoeStrategyV5::rescueDeployedFunds"
        );
