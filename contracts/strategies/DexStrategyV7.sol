 ...
 */
contract DexStrategyV7 is YakStrategy {
    ...
    function setAllowances(uint256 amount) private {
    ...
    function reinvest() external override onlyEOA {
        uint256 unclaimedRewards = checkReward();
        require(unclaimedRewards >= MIN_TOKENS_TO_REINVEST, "DexStrategyV7::reinvest");
        _reinvest(unclaimedRewards);
    }
