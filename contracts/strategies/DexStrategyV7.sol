 ...
 */
contract DexStrategyV7 is YakStrategyV3 {
    ...
    constructor(
        ...
        updateRecoverFundsManager(_recoverFundsManager);
    ...
    function _deposit(address account, uint256 amount)
        ...
        onlyAllowedDeposits
    {
        require(DEPOSITS_ENABLED == true, "DexStrategyV7::_deposit");
    ...
    function withdraw(uint256 amount) external override {
        ...
        if (depositTokenAmount > 0) {
            ...
            _totalDeposits = _totalDeposits.sub(depositTokenAmount);
            emit Withdraw(msg.sender, depositTokenAmount);
        }
    }

    function _withdrawDepositTokens(uint256 amount) private {
        require(amount > 0, "DexStrategyV7::_withdrawDepositTokens");
    ...
    function _reinvest(uint256 amount) private {
        ...
        console.log(amount.sub(devFee).sub(adminFee).sub(reinvestFee));
        ...
        _totalDeposits = _totalDeposits.add(depositTokenAmount);

        emit Reinvest(_totalDeposits, totalSupply);
    }

    function _stakeDepositTokens(uint256 amount) private {
        require(amount > 0, "DexStrategyV7::_stakeDepositTokens");
    ...
    function _safeTransfer(
        ...
        require(
            ...
            "DexStrategyV7::TRANSFER_FROM_FAILED"
        );
    }
        ...
        override
    {
        ...
        require(
            ...
            "DexStrategyV7::rescueDeployedFunds"
        );
        _totalDeposits = balanceAfter;
        emit Reinvest(_totalDeposits, totalSupply);
    }
}
