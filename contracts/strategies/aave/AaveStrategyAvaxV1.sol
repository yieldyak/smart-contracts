...
contract AaveStrategyAvaxV1 is YakStrategyV2Payable, ReentrancyGuard {
    ...
    function _updateLeverage(LeverageSettings memory leverageSettings) internal {
        leverageLevel = leverageSettings.leverageLevel;
        leverageBips = leverageSettings.leverageBips;
        safetyFactor = leverageSettings.safetyFactor;
        minMinting = leverageSettings.minMinting;
    }
