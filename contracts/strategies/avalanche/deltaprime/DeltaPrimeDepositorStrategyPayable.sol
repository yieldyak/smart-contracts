...
import "../../VariableRewardsStrategyPayableForSA.sol";

import "./interfaces/IPool.sol";

contract DeltaPrimeDepositorStrategyPayable is VariableRewardsStrategyPayableForSA {
    ...
    ) VariableRewardsStrategyPayableForSA(address(0), _variableRewardsStrategySettings, _strategySettings) {
        pool = IPool(_pool);
    }

    receive() external payable {
        require(msg.sender == address(WAVAX) || msg.sender == address(pool.poolRewarder()));
    }
