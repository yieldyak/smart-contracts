...
/**
 * @notice VariableRewardsStrategyPayable
 */
abstract contract VariableRewardsStrategyPayable is YakStrategyV2Payable, ReentrancyGuard {
    ...
    function withdraw(uint256 _amount) external override nonReentrant {
        ...
        WAVAX.withdraw(withdrawAmount - withdrawFee);
        (bool success, ) = msg.sender.call{value: withdrawAmount - withdrawFee}("");
        require(success, "DeltaPrimeDepositorStrategy::transfer failed");
