...
/**
 * @notice ElkIlpStrategy should be inherited by new strategies
 */
abstract contract ElkILPStrategy is YakERC20, Ownable, Permissioned {
     ...
     */
    modifier onlyEOA() {
        require(tx.origin == msg.sender, "ElkIlpStrategy::onlyEOA");
        _;
    }
     ...
     */
    modifier onlyDev() {
        require(msg.sender == devAddr, "ElkIlpStrategy::onlyDev");
        _;
    }
    ...
    */
    ...
    /**
     * @notice Coverage tokens available to strategy
     * @return coverage tokens
     */
    function checkCoverage() public virtual view returns (uint);
