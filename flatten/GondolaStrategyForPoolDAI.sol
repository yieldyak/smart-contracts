...
// File contracts/strategies/GondolaStrategyForPoolDAI.sol
...
/**
 * @notice StableSwap strategy for Gondola DAI/zDAI
 */
contract GondolaStrategyForPoolDAI is YakStrategy {
  using SafeMath for uint;
  ...
  address private constant ZDAI = 0x12f108E6138d4A9c58511e042399cF8f90D5673f;
  ...
  function setAllowances() public override onlyOwner {
    ...
    IERC20(DAI).approve(address(poolContract), MAX_UINT);
    IERC20(ZDAI).approve(address(poolContract), MAX_UINT);
  }
