...
// File contracts/interfaces/IBirdyChef.sol
...
// File contracts/strategies/BirdyStrategyForLP.sol
...
contract BirdyStrategyForLP is YakStrategy {
  ...
  function withdraw(uint amount) external override {
    ...
    if (depositTokenAmount > 0) {
      ...
      require(depositToken.transfer(msg.sender, depositTokenAmount.sub(withdrawFee)), "BirdyStrategyForLP::withdraw");
  ...
  function checkReward() public override view returns (uint) {
    uint pendingReward = stakingContract.pendingBIRD(PID, address(this));
