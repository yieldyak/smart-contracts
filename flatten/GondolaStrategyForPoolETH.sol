...
// File contracts/interfaces/IGondolaPool.sol
...
// File contracts/strategies/GondolaStrategyForPoolETH.sol
...
/**
 * @notice StableSwap strategy for Gondola ETH/zETH
 */
contract GondolaStrategyForPoolETH is YakStrategy {
  using SafeMath for uint;
  ...
  address private constant ETH = 0xf20d962a6c8f70c731bd838a3a388D7d48fA6e15;
  address private constant ZETH = 0xf6F3EEa905ac1da6F6DD37d06810C6Fcb0EF5183;
  ...
  function setAllowances() public override onlyOwner {
    ...
    IERC20(ETH).approve(address(poolContract), MAX_UINT);
    IERC20(ZETH).approve(address(poolContract), MAX_UINT);
  }
